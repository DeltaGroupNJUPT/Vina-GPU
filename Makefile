...
SRC=./lib/*.cpp ./OpenCL/src/wrapcl.cpp $(BOOST_LIB_PATH)/libs/thread/src/pthread/thread.cpp $(BOOST_LIB_PATH)/libs/thread/src/pthread/once.cpp #../boost_1_77_0/boost/filesystem/path.hpp
MACRO=#-DBUILD_KERNEL_FROM_SOURCE -DDISPLAY_SUCCESS -DDISPLAY_ADDITION_INFO
OPTION=-fpermissive -Wnarrowing -O3 #-g
all:out
out:./main/main.cpp
	gcc -o Vina-GPU $(BOOST_INC_PATH) $(VINA_GPU_INC_PATH) $(OPENCL_INC_PATH) ./main/main.cpp $(SRC) $(LIB1) $(LIB2) $(LIB3) $(LIB_PATH) $(MACRO) $(OPTION)
clean:
	rm Vina-GPU
